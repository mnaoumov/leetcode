...
/// <summary>
/// https://leetcode.com/submissions/detail/942205370/
/// </summary>
[UsedImplicitly]
...
public class Solution5 : ISolution
{
    public int MinCost(int maxTime, int[][] edges, int[] passingFees)
    {
        ...
        var minCosts = Enumerable.Repeat(int.MaxValue, n).ToArray();
        ...
        while (pq.Count > 0)
        {
            ...
            foreach (var edge in timeGraph.AdjacentEdges(city))
            {
                ...
                var nextCost = cost + passingFees[nextCity];

                if (minCosts[nextCity] < nextCost)
                {
                    continue;
                }

                Enqueue(nextCity, nextTime, nextCost);
            }
        }

...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-356/submissions/detail/1007374431/
/// </summary>
[UsedImplicitly]
    ...
    public int CountSteppingNumbers(string low, string high)
    {
        ...
        var dp = new DynamicProgramming<(string low2, string high2, int previousDigit), ModNumber>((key, recursiveFunc) =>
        {
            ...
            for (var firstDigit = lowDigit; firstDigit <= highDigit; firstDigit++)
            {
                ...
                var nextPreviousDigit = firstDigit > 0 || low2.Length <= low.Length ? firstDigit : noDigit;

...
/// <summary>
/// https://leetcode.com/submissions/detail/1121569929/
/// </summary>
[UsedImplicitly]
public class Solution6 : ISolution
{
    public long MinimumCost(int[] nums)
    {
        ...
        palindromesByLength[1].AddRange(Enumerable.Range(0, 10));
        ...
        if (index < 0)
        {
            ...
            if (greaterPalindromeIndex == palindromes.Count)
            {
                greaterPalindromeIndex = palindromes.Count - 1;
            }
        }
        else
        {

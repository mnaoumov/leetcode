...
/// <summary>
/// https://leetcode.com/submissions/detail/963945797/
/// </summary>
[UsedImplicitly]
...
public class Solution3 : ISolution
{
    ...
    private class Trie
    {
        ...
        public class Node
        {
            ...
            private readonly Node?[] _letterNodes = new Node?[LettersCount];
            public Node GetOrAddLetterNode(char letter) => GetLetterNode(letter) ?? (_letterNodes[ToIndex(letter)] = new Node());

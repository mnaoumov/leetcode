...
/// <summary>
/// https://leetcode.com/problems/design-excel-sum-formula/submissions/1934177041/
/// </summary>
[UsedImplicitly]
...
public class Solution2 : ISolution
{
    ...
    private sealed class Excel : IExcel
    {
        ...
        {
            var cellRef = new CellRef(row, column);
            GetCell(cellRef).Value = new SumCellValue(this, numbers.SelectMany(CellRef.Parse).ToArray());
            CellChanged?.Invoke(this, new CellChangedEventArgs(cellRef));
    ...
    private sealed class SumCellValue : CellValue
    {
        ...
        public SumCellValue(Excel excel, CellRef[] cellRefs)
        {
            _excel = excel;
            _cellRefs = cellRefs;

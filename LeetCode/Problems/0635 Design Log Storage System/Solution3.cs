...
/// <summary>
/// https://leetcode.com/problems/design-log-storage-system/submissions/1942652732/
/// </summary>
[UsedImplicitly]
public class Solution3 : ISolution
{
    ...
    private sealed class LogSystem : ILogSystem
    {
        ...
        private readonly Dictionary<string, List<int>> _timestampIdsMap = new();

        public void Put(int id, string timestamp)
        {
            _timestamps.Add(timestamp);
            _timestampIdsMap.TryAdd(timestamp, new List<int>());
            _timestampIdsMap[timestamp].Add(id);
        }
        ...
        public IList<int> Retrieve(string start, string end, string granularity)
        {
            ...
            return _timestamps.GetViewBetween(start, end).SelectMany(timestamp => _timestampIdsMap[timestamp]).ToList();
        }

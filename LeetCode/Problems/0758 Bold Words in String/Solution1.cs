...
/// <summary>
/// https://leetcode.com/problems/bold-words-in-string/submissions/2076483247/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public string BoldWords(string[] words, string s)
    {
        ...
        foreach (var word in words)
        {
            ...
            while (true)
            {
                var startIndex = s.IndexOf(word, lastEndIndex, StringComparison.Ordinal);
                ...
                lastEndIndex = startIndex + word.Length;
                intervals.Add(new Interval(startIndex, lastEndIndex));
            }
        }

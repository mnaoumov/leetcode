...
/// <summary>
/// https://leetcode.com/submissions/detail/859976072/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public int LongestCommonSubsequence(string text1, string text2)
    {
        var dp = new DynamicProgramming<(int index1, int index2), int>((key, recursiveFunc) =>
        {
            ...
            return Math.Max(recursiveFunc((index1 - 1, index2)), recursiveFunc((index1, index2 - 1))) + (text1[index1] == text2[index2] ? 1 : 0);
        });

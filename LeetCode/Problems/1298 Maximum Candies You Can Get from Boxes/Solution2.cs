...
/// <summary>
/// https://leetcode.com/problems/maximum-candies-you-can-get-from-boxes/submissions/1652236176/
/// </summary>
[UsedImplicitly]
...
public class Solution2 : ISolution
{
    public int MaxCandies(int[] status, int[] candies, int[][] keys, int[][] containedBoxes, int[] initialBoxes)
    {
        ...
        while (processingBoxes.Count > 0)
        {
            ...
            foreach (var keyBox in box.KeyBoxes.Where(keyBox => keyBox is { IsProcessed: false, IsAvailable: true, IsOpen: false }))
            {
                keyBox.IsOpen = true;

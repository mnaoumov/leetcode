...
/// <summary>
/// https://leetcode.com/problems/kth-smallest-product-of-two-sorted-arrays/submissions/1675530220/
/// </summary>
[UsedImplicitly]
        ...
        long BinarySearch(long low, long high)
        {
            ...
            foreach (var num1 in nums1)
            {
                switch (num1)
                {
                    ...
                    case > 0:
                        {
                            var boundary2 = (long) Math.Floor((double) mid / num1);
                            ...
                            {
                                notGreaterProductCount += BinarySearchFirst(nums2, (int) boundary2 + 1);
                            }
                    ...
                    default:
                        {
                            ...
                            {
                                notGreaterProductCount += nums2.Length - (BinarySearchLast(nums2, (int) boundary2 - 1) + 1);
                            }

...
/// <summary>
/// https://leetcode.com/problems/maximum-fruits-harvested-after-at-most-k-steps/submissions/1721431032/
/// </summary>
[UsedImplicitly]
        ...
        foreach (var (positionRight, totalAmountToRight) in amountsToRight)
        {
            ...
            if (minPositionLeft < startPos)
            {
                ...
                if (0 <= index && index < fruitObjs.Length)
                {
                    ...
                    totalAmountToLeft = amountsToLeft.GetValueOrDefault(minPositionLeft, 0);
                }
            }

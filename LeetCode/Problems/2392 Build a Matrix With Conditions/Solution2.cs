...
/// <summary>
/// https://leetcode.com/submissions/detail/1328916677/
/// </summary>
[UsedImplicitly]
public class Solution2 : ISolution
{
    ...
    {
        var rowConditionsTs = new TopologicalSort<int>(BuildGraph(k, rowConditions));
        var colConditionsTs = new TopologicalSort<int>(BuildGraph(k,colConditions));
    ...
    private static DirectedGraph<int> BuildGraph(int k, int[][] conditions)
    {

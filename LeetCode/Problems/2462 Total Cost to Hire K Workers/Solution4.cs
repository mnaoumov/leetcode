...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-318/submissions/detail/837788601/
/// </summary>
[UsedImplicitly]
public class Solution4 : ISolution
{
    ...
    public long TotalCost(int[] costs, int k, int candidates)
    {
        ...
        for (var i = 0; i < k; i++)
        {
            ...
            var lastQueueIndex = lastQueue.Count > 0 ? lastQueue.Peek() : Empty;

            var firstQueueCost = 0 <= firstQueueIndex && firstQueueIndex < costs.Length ? costs[firstQueueIndex] : int.MaxValue;
            var lastQueueCost = 0 <= lastQueueIndex && lastQueueIndex < costs.Length ? costs[lastQueueIndex] : int.MaxValue;

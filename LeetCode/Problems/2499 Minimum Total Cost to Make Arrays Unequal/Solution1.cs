...
/// <summary>
/// https://leetcode.com/submissions/detail/858979321/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public long MinimumTotalCost(int[] nums1, int[] nums2)
    {
        ...
        while ((numWithMaxCount > numToSwapCount / 2 || numToSwapCount % 2 == 1 && !indicesToSwap.Contains(0)) && i < n)
        {
        ...
        if (numWithMaxCount > numToSwapCount / 2)
        {
            return -1;
        }

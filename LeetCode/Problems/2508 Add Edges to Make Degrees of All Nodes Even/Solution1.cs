...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-324/submissions/detail/861416077/
/// </summary>
[UsedImplicitly]
    ...
    public bool IsPossible(int n, IList<IList<int>> edges)
    {
        ...
        while (oddNodes.Count > 0)
        {
            ...
            else
            {
                ...
                oddNode2 = oddNodes.FirstOrDefault(oddNode => GetEvenCandidates(oddNode).Overlaps(evenCandidates));

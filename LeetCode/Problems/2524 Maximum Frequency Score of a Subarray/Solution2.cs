...
/// <summary>
/// https://leetcode.com/submissions/detail/870791004/
/// </summary>
[UsedImplicitly]
...
public class Solution2 : ISolution
{
    ...
    public int MaxFrequencyScore(int[] nums, int k)
    {
        ...
        var result = AddByModulo(frequenciesMap.Select(kvp => PowerByModulo(kvp.Key, kvp.Value)));
        ...
        for (var i = k; i < nums.Length; i++)
        {
            ...
            var nextResult = AddByModulo(new[]
            {
                result,

...
/// <summary>
/// https://leetcode.com/submissions/detail/900538272/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public long[] HandleQuery(int[] nums1, int[] nums2, int[][] queries)
    {
        ...
        var fromComparer = Comparer<(int from, int to)>.Create((interval1, interval2) => interval1.from.CompareTo(interval2.to));
        ...
        foreach (var query in queries)
        {
            ...
            switch (queryType)
            {
                case 1:
                    var l = query[1];
                    var r = query[2];
                    var index = flipIntervals.BinarySearch((l, r), fromComparer);
                    ...
                    var mergedIntervals = MergeIntervals(previousInterval, (l, r), nextInterval)
        ...
        {
            var onesCount = oneCountsOnTheLeft[flipInterval.to + 1] - oneCountsOnTheLeft[flipInterval.from];
            return flipInterval.to - flipInterval.from + 1 - 2 * onesCount;
        }
    }

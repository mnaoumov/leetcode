...
/// <summary>
/// https://leetcode.com/submissions/detail/1259316280/
/// </summary>
[UsedImplicitly]
...
public class Solution11 : ISolution
{
    public int MaximumSafenessFactor(IList<IList<int>> grid)
    {
        ...
        var maxSafenessFactor = 0;
        InitCellSafenessFactors();

        var low = 0;
        var high = maxSafenessFactor;
        ...
        {
            if (cellSafenessFactors[0, 0] < safenessFactor || cellSafenessFactors[n - 1, n - 1] < safenessFactor)
            {
                return false;
            }
        ...
        void InitCellSafenessFactors()
        {
            ...
            while (queue.Count > 0)
            {
                maxSafenessFactor = safenessFactor;

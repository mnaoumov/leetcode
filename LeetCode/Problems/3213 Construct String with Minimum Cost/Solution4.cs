...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-405/submissions/detail/1312364533/
/// </summary>
[UsedImplicitly]
        ...
        var dp = new DynamicProgramming<(int start, int end), int>((key, recursiveFunc) =>
        {
            ...
            foreach (var startIndexCost in startIndicesCost)
            {
                ...
                for (var i = 0; i <= high; i++)
                {
                    ...
                    ans = Math.Min(ans,
                        startIndexCost.cost + endIndexCost.cost +
                        recursiveFunc((startIndexCost.index + 1, endIndexCost.index - 1)));
                }
            }

...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-411/submissions/detail/1359790667/
/// </summary>
[UsedImplicitly]
public class Solution2 : ISolution
{
    public long MaxEnergyBoost(int[] energyDrinkA, int[] energyDrinkB)
    {
        ...
        var dp = new DynamicProgramming<(int index, bool isDrinkA), long>((key, recursiveFunc) =>
        {

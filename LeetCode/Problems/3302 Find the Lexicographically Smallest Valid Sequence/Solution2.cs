...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-140/submissions/detail/1405022496/
/// </summary>
[UsedImplicitly]
...
public class Solution2 : ISolution
{
    public int[] ValidSequence(string word1, string word2)
    {
        ...
        var dp = new DynamicProgramming<(int index, int digitsLeft, bool allowNonEqual), IEnumerable<int>>((key, recursiveFunc) =>
    {
        ...
        if (word1[index] == word2[^digitsLeft])
        {
            ...
            return next != impossible ? new[] { index }.Concat(next) : impossible;
        }
        ...
        return dp.GetOrCalculate((0, word2.Length, true)).ToArray();
    }

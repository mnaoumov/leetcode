...
/// <summary>
/// https://leetcode.com/problems/total-characters-in-string-after-transformations-ii/submissions/1633412172/
/// </summary>
[UsedImplicitly]
        ...
        public override string ToString()
        {
            return string.Join("\n",
                Enumerable.Range(0, Rows).Select(row =>
                    string.Join(" ", Enumerable.Range(0, Columns).Select(column => this[row, column])))
            );
        }
    }

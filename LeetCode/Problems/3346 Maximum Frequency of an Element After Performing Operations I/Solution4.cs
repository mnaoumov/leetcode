...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-143/submissions/detail/1447777595/
/// </summary>
[UsedImplicitly]
...
public class Solution4 : ISolution
{
    public int MaxFrequency(int[] nums, int k, int numOperations)
    {
        ...
        for (var i = 0; i < n; i++)
        {
            ...
            var mid = num + nums[lastIndexSameValue + 1] >> 1;
            ans = Math.Max(ans,
                Math.Min(numOperations,
                    1 +
                    BinarySearchLast(nums, mid + k, lastIndexSameValue + 1) -

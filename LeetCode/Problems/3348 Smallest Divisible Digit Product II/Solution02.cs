...
/// <summary>
/// https://leetcode.com/problems/smallest-divisible-digit-product-ii/submissions/2097418747/
/// </summary>
[UsedImplicitly]
    ...
    public string SmallestNumber(string num, long t)
    {
        ...
        var dp = new DynamicProgramming<(long divisor, string minNumStr, bool isStart), string>((key, getOrCalculate) =>
        {
            ...
            while (true)
            {
                ...
                var nextMinNumStr = prefix == minPrefix && minNumStr.Length > 1 ? minNumStr[1..] : "1";

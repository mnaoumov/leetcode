...
/// <summary>
/// https://leetcode.com/problems/smallest-divisible-digit-product-ii/submissions/2097460755/
/// </summary>
[UsedImplicitly]
...
public class Solution08 : ISolution
{
    public string SmallestNumber(string num, long t)
    {
        ...
        {
            return num[..^(minStrForT.Length + 1)] + dp.GetOrCalculate((t, num[^(minStrForT.Length + 1)..], false));
        }

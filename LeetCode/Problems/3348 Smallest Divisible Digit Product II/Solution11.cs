...
/// <summary>
/// https://leetcode.com/problems/smallest-divisible-digit-product-ii/submissions/2097505770/
/// </summary>
[UsedImplicitly]
...
public class Solution11 : ISolution
{
    public string SmallestNumber(string num, long t)
    {
        ...
        if (num.Length >= minStrForT.Length + 1)
        {
            ...
            var prefixStr = num[..^(minStrForT.Length + 1)];
            var nextDivisor = NextDivisor(prefixStr, t);

            var subResult = dp.GetOrCalculate((nextDivisor, num[^(minStrForT.Length + 1)..], false));
            ...
            if (subResult != impossible)
            {
                return subResult.Length == minStrForT.Length ? prefixStr + "1" + subResult : prefixStr + subResult;
            }

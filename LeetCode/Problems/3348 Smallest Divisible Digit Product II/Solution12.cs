...
/// <summary>
/// https://leetcode.com/problems/smallest-divisible-digit-product-ii/submissions/2097508869/
/// </summary>
[UsedImplicitly]
public class Solution12 : ISolution
{
    public string SmallestNumber(string num, long t)
    {
        ...
        if (num.Length >= minStrForT.Length + 1)
        {
            ...
            if (subResult != impossible)
            {
                return prefixStr + new string('1', minStrForT.Length + 1 - subResult.Length) + subResult;
            }

...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-425/submissions/detail/1461305418/
/// </summary>
[UsedImplicitly]
...
public class Solution3 : ISolution
{
    public long MaximizeSumOfWeights(int[][] edges, int k)
    {
        ...
        for (var i = 0; i < n; i++)
        {
            edgeCounts[i] = Math.Max(edgeCounts[i], k);
        }
        ...
        var dp = new DynamicProgramming<(int index, string edgeCountsStr), int>((key, recursiveFunc) =>
        {
            ...
            edgeCounts2[u]--;
            edgeCounts2[v]--;
            edgeCounts2[u] = Math.Max(edgeCounts2[u], k);
            edgeCounts2[v] = Math.Max(edgeCounts2[v], k);

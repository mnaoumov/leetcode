...
/// <summary>
/// https://leetcode.com/problems/length-of-longest-v-shaped-diagonal-segment/submissions/1749617567/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public int LenOfVDiagonal(int[][] grid)
    {
        ...
        var dp = new DynamicProgramming<(int row, int column, int dRow, int dColumn, bool canChangeDirection), int>((key, recursiveFunc) =>
        {
            ...
            foreach (var (newDRow, newDColumn) in new[] { (dRow, -dColumn), (-dRow, dColumn) })
            {
                ans = Math.Max(ans, recursiveFunc((row, column, newDRow, newDColumn, false)));
            }

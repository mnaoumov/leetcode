...
/// <summary>
/// https://leetcode.com/problems/maximize-the-distance-between-points-on-a-square/submissions/1988420042/
/// </summary>
[UsedImplicitly]
...
public class Solution5 : ISolution
{
    public int MaxDistance(int side, int[][] points, int k)
    {
        ...
        bool CanSelectKPoints(int minDistance)
        {
            ...
            return Math.Abs(point.X - startPoint.X) + Math.Abs(point.Y - startPoint.Y) >= minDistance;
        }
    }

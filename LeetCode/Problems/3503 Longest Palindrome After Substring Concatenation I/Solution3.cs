...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-443/problems/longest-palindrome-after-substring-concatenation-i/submissions/1590639315/
/// </summary>
[UsedImplicitly]
    ...
    public int LongestPalindrome(string s, string t)
    {
        ...
        for (var i = 0; i <= n - ans; i++)
        {
            for (var j = i + ans; j <= n; j++)
            {
                ...
                var lastTIndex = t.LastIndexOf(reversedSubS, StringComparison.Ordinal);
                ...
                ans = Math.Max(ans, 2 * (j - i) + (j < n || lastTIndex > 0 ? 1 : 0));
            }
        }

...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-159/problems/count-prime-gap-balanced-subarrays/submissions/1671738382/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public int PrimeSubarray(int[] nums, int k)
    {
        ...
        var dp = new DynamicProgramming<(int index, int min, int max, int primesCount), int>((key, recursiveFunc) =>
        {
            ...
            {
                return recursiveFunc((index + 1, min, max, primesCount));
            }

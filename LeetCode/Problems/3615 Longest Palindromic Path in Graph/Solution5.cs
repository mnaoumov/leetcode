...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-458/problems/longest-palindromic-path-in-graph/submissions/1695924895/
/// </summary>
[UsedImplicitly]
...
public class Solution5 : ISolution
{
    public int MaxLen(int n, int[][] edges, string label)
    {
        ...
        while (queue.Count > 0)
        {
            ...
            foreach (var nextHead in adjNodes[head].Where(nextNode => !nextVisitedNodes.Contains(nextNode)))
            {
                foreach (var nextTail in adjNodes[tail].Where(nextNode => !nextVisitedNodes.Contains(nextNode)))
                {

...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-463/problems/best-time-to-buy-and-sell-stock-using-strategy/submissions/1737958833/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public long MaxProfit(int[] prices, int[] strategy, int k)
    {
        ...
        for (var j = 1; j < n - k; j++)
        {
            ...
            sum -= prices[j + k / 2 - 1] * strategy[j + k / 2 - 1];

...
/// <summary>
/// https://leetcode.com/problems/xor-after-range-multiplication-queries-ii/submissions/1973233571/
/// </summary>
[UsedImplicitly]
public class Solution3 : ISolution
{
    public int XorAfterQueries(int[] nums, int[][] queries)
    {
        ...
        return arr.Aggregate(0, (a, b) => a ^ b);
    }

    private sealed record Query(int LeftIndex, int RightIndex, int Step, int Multiplicator);

    private readonly struct ModNumber : IEquatable<ModNumber>
    {
        ...
        private static ModNumber Pow(ModNumber value, int exponent)
        {
            ModNumber ans = 1;
            var powerOfTwo = value;
        ...
        public bool Equals(ModNumber other) => _value == other._value;

        public override bool Equals(object? obj) => obj is ModNumber other && Equals(other);

        public override int GetHashCode() => _value;

        public static bool operator ==(ModNumber left, ModNumber right) => left.Equals(right);

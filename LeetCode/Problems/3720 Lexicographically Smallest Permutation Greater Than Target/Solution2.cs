...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-472/problems/lexicographically-smallest-permutation-greater-than-target/submissions/1805566532/
/// </summary>
[UsedImplicitly]
public class Solution2 : ISolution
{
    ...
    private static string GetNextPermutation(Dictionary<char, int> sourceLetterCounts, SortedSet<char> sortedLetters, string target, int index)
    {
        ...
        var nextLetter = sortedLetters.GetViewBetween((char) (targetLetter + 1), char.MaxValue).Min;

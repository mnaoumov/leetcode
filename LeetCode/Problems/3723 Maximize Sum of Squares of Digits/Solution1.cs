...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-168/problems/maximize-sum-of-squares-of-digits/submissions/1811312065/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public string MaxSumOfSquares(int num, int sum)
    {
        ...
        var dp = new DynamicProgramming<(int digitsCount, int digitsSum), (int maxScore, string maxScoreStr)>((key, getOrCalculate) =>
        {
            ...
            if (digitsCount == 1)
            {
                return digitsSum < 10 ? (digitsSum * digitsSum, maxScoreStr: digitsSum.ToString()) : impossible;
            }

            var minDigit = digitsCount == num ? 1 : 0;
            var maxDigit = Math.Min(9, digitsSum);

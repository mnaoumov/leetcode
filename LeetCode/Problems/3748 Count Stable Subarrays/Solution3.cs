...
/// <summary>
/// https://leetcode.com/contest/weekly-contest-476/problems/count-stable-subarrays/submissions/1830956994/
/// </summary>
[UsedImplicitly]
...
public class Solution3 : ISolution
{
    public long[] CountStableSubarrays(int[] nums, int[][] queries)
    {
        ...
        long Answer(int l, int r)
        {
            ...
            if (startIntervalIndexOfIndex == endIntervalIndexOfIndex + 1 && startIntervalIndexOfIndex < stableIntervalLengths.Count)
            {

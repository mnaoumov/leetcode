...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-171/problems/maximize-points-after-choosing-k-tasks/submissions/1848451941/
/// </summary>
[UsedImplicitly]
...
public class Solution2 : ISolution
{
    public long MaxPoints(int[] technique1, int[] technique2, int k)
    {
        ...
        var dp = new DynamicProgramming<(int index, int minTechnique1Tasks), long>((key, getOrCalculate) =>
        {
            ...
            if (n > index + minTechnique1Tasks && technique2[index] > technique1[index])
            {

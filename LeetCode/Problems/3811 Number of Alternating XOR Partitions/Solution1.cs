...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-174/problems/number-of-alternating-xor-partitions/submissions/1887896197/
/// </summary>
[UsedImplicitly]
...
public class Solution1 : ISolution
{
    public int AlternatingXOR(int[] nums, int target1, int target2)
    {
        ...
        var dp = new DynamicProgramming<(int index, int indexGroupIndex), ModNumber>((key, getOrCalculate) =>
        {
            ...
            for (var i = indexOfIndex; i < indexGroup.Count; i++)
            {
                ans += getOrCalculate((indexGroup[i] + 1, (indexGroupIndex + 1) % 4));
            }

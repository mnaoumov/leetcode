...
/// <summary>
/// https://leetcode.com/contest/biweekly-contest-177/problems/minimum-operations-to-make-array-parity-alternating/submissions/1933824477/
/// </summary>
[UsedImplicitly]
        ...
        else
        {
            for (var initialParity = 0; initialParity <= 1; initialParity++)
            {
                ...
                foreach (var deltaMin in new[] { -1, 1 })
                {
                    ...
                    {
                        if (minUnfixed == maxUnfixed && deltaMin != deltaMax)
                        {
                            continue;
                        }
